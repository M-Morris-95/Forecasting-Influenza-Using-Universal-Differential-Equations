                ...
                for ode_name in ode_names:
                    ...
                    if run:            
                        ...
                        for epoch in range(10):
                            model.ode.Fa_w += 0.1
                            model.train(train_loader, t, 1, losses, eval_pts, n_samples = n_samples, grad_lim=1500, checkpoint=True, track_norms=True, norm_file=f'{norm_prefix}norms.txt', disable=True)
                        model.train(train_loader, t, 100, losses, eval_pts, n_samples = n_samples, grad_lim=1500, checkpoint=True, track_norms=True, norm_file=f'{norm_prefix}norms.txt', disable=True)
