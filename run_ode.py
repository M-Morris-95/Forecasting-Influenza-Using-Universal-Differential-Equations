...
# model training info
training_info =   {
    'UONN': {'nll':True, 'mse':False, 'kl_z':True, 'kl_p':True,  'Fa_norm':1e-1,  'reg_loss':True,  'anneal':True},
    ...
    'UONNb': {'nll':True, 'mse':False, 'kl_z':True, 'kl_p':True,  'Fa_norm':1e-1,  'reg_loss':True,  'anneal':True},
                    ...
                    for num in nums:
                        for test_season in test_seasons:
                            for ode_name in ode_names:
                                ...
                                common_prefix = f'{region}/{ode_name}/{test_season}_e{epochs}_g{gamma}_w{window_size}_{num}_'
