...
if __name__ == '__main__':
    ...
    fill_1 = True
    if fill_1:
        eval_pts = torch.arange(t.shape[0])
        interp_prefix = '_no_interp'
    else:
        interp_prefix = ''
        ...
        for region in regions:
            for test_season in test_seasons:
                for ode_name in ode_names:
                    ...
                    file_prefix = f'weights/{region}/{ode_name}{interp_prefix}/{test_season}_{num}_'
                    norm_prefix = f'norms/{region}/{ode_name}{interp_prefix}/{test_season}_{num}_'
                    chkpt_prefix = f'chkpts/{region}/{ode_name}{interp_prefix}/{test_season}_{num}_'
                    ...
                    if run:            
                        ...
                        _data = DataConstructor(test_season=test_season, region = region, window_size=window_size, n_queries=n_qs, fill_1 = fill_1, gamma=gamma)
